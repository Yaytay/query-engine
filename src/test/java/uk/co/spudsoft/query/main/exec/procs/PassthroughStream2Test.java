...
public class PassthroughStream2Test {
  
  @SuppressWarnings("constantname")
  private static final Logger logger = LoggerFactory.getLogger(PassthroughStream2Test.class);
  ...
  public void testQuickProcessor(Vertx vertx, VertxTestContext testContext) {    
    ...
    vertx.getOrCreateContext().runOnContext(v -> {
      ...
      PassthroughStream2<JsonObject> instance = new PassthroughStream2<>(
              (row, chain) -> {
