...
public class Parameters {
  ...
  /**
   * In "Design Mode" the design UI is accessible to users and query definitions can be written.
   * Design mode is inherently insecure, it should NEVER be used in a live configuration.
   * The security of the Query Engine is dependent upon only authorised personnel creating queries, design mode lets any user do it.
   * The intention is that design mode be used in a private instance running in Docker on the developers desktop.
   */
   ...
   * @return this, so that the method may be called in a fluent manner.
   */
  public Parameters setDesignMode(boolean designMode) {
