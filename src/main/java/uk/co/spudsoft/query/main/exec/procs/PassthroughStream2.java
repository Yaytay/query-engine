 ...
 * @author jtalbut
 */
public class PassthroughStream2<T> {
  
  @SuppressWarnings("constantname")
  private static final Logger logger = LoggerFactory.getLogger(PassthroughStream2.class);
  ...
  public PassthroughStream2(PassthroughProcessor<T> processor, Context context) {
