...
| Override the level of individual
link:https://www.slf4j.org/api/org/slf4j/Logger.html[org.slf4j.Logger] s.
This enables configuration like: logging.level.uk.co.spudsoft.query.main=DEBUG
