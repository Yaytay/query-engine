...
| Set the WebClientOptions that will be used when creating the Vert.x WebClients.The default value sets a connect timeout of 10s to avoid excessive delays on bad URLs.
