...
It spawns four containers: MySQL, Microsoft SQL Server, PostgreSQL and Query Engine in link:pass:[Design Mode/Design Mode.MD][Design Mode].
...
platforms with a link:Samples/Sample%20Data.MD[very similar structure and data].
