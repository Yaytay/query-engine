...
public class InfoHandlerTest {
  ...
  public void testReportErrorWithServiceException() {
    ...
    assertEquals("ServiceException: It went wrong\n\t\tuk.co.spudsoft.query.web.rest.InfoHandlerTest:46\n\t\tjdk.internal.reflect.DirectMethodHandleAccessor:104", responseCaptor.getValue().getEntity());
  }
