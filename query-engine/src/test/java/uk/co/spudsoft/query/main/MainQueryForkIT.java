...
public class MainQueryForkIT {
  ...
  private static final Logger logger = LoggerFactory.getLogger(MainQueryForkIT.class);
  ...
  public void testQuery() throws Exception {
    ...
    assertThat(body, startsWith("{\"name\":\"\",\"children\":[{\"name\":\"args\",\"children\":[{\"name\":\"Args00\",\"path\":\"args/Args00\",\"title\":\"No Arguments\",\"description\":\"Test pipeline that has no arguments\",\"type\":\"file\"},{\"name\":\"Args01\",\"path\":\"args/Args01\",\"title\":\"One Argument\",\"description\":\"Test pipeline that has 1 argument\",\"type\":\"file\"}"));
