...
public class LogoutDiscoveryDatabaseBackIT extends AbstractLoginLogoutTester {

  private static final Logger logger = LoggerFactory.getLogger(LogoutDiscoveryDatabaseBackIT.class);
  ...
  public void testLoginLogout() throws Exception {
    ...
    main.testMain(new String[]{
      "--persistence.datasource.url=" + postgres.getJdbcUrl(),
       ...
       "--session.oauth.test.issuer=http://localhost:" + oidcPort + "/",
