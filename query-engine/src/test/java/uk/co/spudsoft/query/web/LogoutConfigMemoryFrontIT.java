...
public class LogoutConfigMemoryFrontIT extends AbstractLoginLogoutTester {

  private static final Logger logger = LoggerFactory.getLogger(LogoutConfigMemoryFrontIT.class);
  ...
  public void testLoginLogout() throws Exception {
    ...
    performFrontChannelLogout(main.getPort(), cookies);
