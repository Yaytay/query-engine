...
public class ProcessorQuery implements Processor {
  ...
  @Override
  public ProcessorQueryInstance createInstance(Vertx vertx, MeterRegistry meterRegistry, Auditor auditor, PipelineContext pipelineContext, String name) {
    return new ProcessorQueryInstance(vertx, meterRegistry, auditor, pipelineContext, this, name);
  }
