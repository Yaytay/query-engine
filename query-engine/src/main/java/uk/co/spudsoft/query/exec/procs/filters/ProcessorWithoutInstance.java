 ...
 * @author jtalbut
 */
public class ProcessorWithoutInstance implements ProcessorInstance {
  
  @SuppressWarnings("constantname")
  private static final Logger logger = LoggerFactory.getLogger(ProcessorWithoutInstance.class);
  
  private final SourceNameTracker sourceNameTracker;
  private final Context context;
  private final ProcessorWithout definition;
  ...
  public ProcessorWithoutInstance(Vertx vertx, SourceNameTracker sourceNameTracker, Context context, ProcessorWithout definition) {
    this.sourceNameTracker = sourceNameTracker;
    this.context = context;
    this.definition = definition;
    this.stream = new PassthroughStream(sourceNameTracker, this::passthroughStreamProcessor, context);
    this.fields = ImmutableSet.copyOf(definition.getFields());
  }  
