...
public class Endpoint {
  ...
  /**
   * Get a StringTemplate that will be evaluated as the URL for the Endpoint.
   * Invalid if the URL value is set to a non-empty string.
   * For security reasons the URL should not contain credentials - the URL may be logged but the username and password will not be.
   * @return a StringTemplate that will be evaluated as the URL for the Endpoint.
   */
  @Schema(description = """
                        <P>A StringTemplate that will be evaluated as the URL that defines the Endpoint.</P>
                        <P>
